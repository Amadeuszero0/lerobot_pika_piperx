...
from .multiple_xarm_robot_config import MultipleXArmRobotConfig
from .xarm_robot import XArmRobot


class MultipleXArmRobot(Robot):

    config_class = MultipleXArmRobotConfig
    name = "Multiple xArm Robots"

    def __init__(self, config: MultipleXArmRobotConfig):
        ...
        for key, robot_config in self.config.robots.items():
            ...
            robot = XArmRobot(robot_config, prefix=key)
