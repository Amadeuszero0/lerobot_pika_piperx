...
def main():
  ...
  lerobot-real-camera-view -T xvisio -l             # list all XVisio vSLAM
  lerobot-real-camera-view -T realsense -l          # list all RealSense
  lerobot-real-camera-view -T xvisio                # show all XVisio (default 1280x1280 YU12)
  lerobot-real-camera-view -T xvisio -s 250801DR48  # filter by serial number
  lerobot-real-camera-view -T xvisio -W 1280 -H 1280 -F YU12  # specify format (main camera)
  lerobot-real-camera-view -T xvisio -W 640 -H 1920 -F NV12  # specify format (aux cameras)
  lerobot-real-camera-view -T other                # show other cameras
  lerobot-real-camera-view -T other -t 30           # preview 30 seconds
  DISPLAY_W=2560 DISPLAY_H=1440 lerobot-real-camera-view -T xvisio  # set window size limit""")
