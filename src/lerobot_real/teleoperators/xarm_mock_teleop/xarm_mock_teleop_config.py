...
@TeleoperatorConfig.register_subclass("lerobot_real::xarm_mock_teleop")
@dataclass
class XArmMockTeleopConfig(TeleoperatorConfig):
    ...
    def __post_init__(self):
        self.id = 'xarm_mock_teleop' if self.id is None else self.id
